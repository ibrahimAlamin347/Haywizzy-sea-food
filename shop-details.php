<?php require "includes/header1.php"?>
    <title>Haywizzy online Sea Food | Product Details</title>
          ...
          <div class="col-lg-12 text-center">
            <div class="breadcrumb__text">
              ...
              <div class="breadcrumb__option">
                ...
                <a href="index.html">Catfish categories</a>
                <span>Catfish</span>
              </div>
            </div>
          </div>
            ...
            <div class="product__details__pic">
              <div class="product__details__pic__item">
                <img
                  ...
                  src="img/product/details/product-details.jpg"
                  alt="" 
                />
              </div>
              <div class="product__details__pic__slider owl-carousel">
                <img
                  ...
                  src="img/product/details/thumb1.jpg"
                  alt="" style="height: 6em;width:10em"
                />
                <img
                  data-imgbigurl="img/product/details/product-details-3.jpg"
                  src="img/product/details/thumb2.jpg"
                  alt="" style="height: 6em;width:10em"
                />
                <img
                  data-imgbigurl="img/product/details/product-details-5.jpg"
                  src="img/product/details/thumb3.jpg"
                  alt="" style="height: 6em;width:10em"
                />
                <img
                  data-imgbigurl="img/product/details/product-details-4.jpg"
                  src="img/product/details/thumb4.jpg"
                  alt="" style="height: 6em;width:10em"
                />
              </div>
            </div>
